...
This project is indexed by GitNexus as **nu_plugin** (4265 symbols, 10393 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/nu_plugin/context` | Codebase overview, check index freshness |
| `gitnexus://repo/nu_plugin/clusters` | All functional areas |
| `gitnexus://repo/nu_plugin/processes` | All execution flows |
| `gitnexus://repo/nu_plugin/process/{name}` | Step-by-step execution trace |
