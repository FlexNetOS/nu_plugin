...
This project is indexed by GitNexus as **nu_plugin** (4542 symbols, 11049 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
