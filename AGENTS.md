...
This project is indexed by GitNexus as **nu_plugin** (4125 symbols, 9998 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
